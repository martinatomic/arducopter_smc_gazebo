...
class HeightControl:
    ...
    def __init__(self):
        ...
        self.pid_vx.set_kp(40)
        self.pid_vx.set_ki(2)
        self.pid_vx.set_kd(4)
        self.pid_vx.set_lim_high(0.04 * self.w0)
        self.pid_vx.set_lim_low(-0.04 * self.w0)

        self.pid_vy.set_kp(0)
        self.pid_vy.set_ki(0)
        self.pid_vy.set_kd(0)
        self.pid_vy.set_lim_high(0.02 * self.w0)
        self.pid_vy.set_lim_low(-0.02 * self.w0)
